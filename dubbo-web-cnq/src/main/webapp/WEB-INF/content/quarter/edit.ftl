...
<form id="inputForm" method="post" action="update">
	<input type="hidden" id="infoId" name="id" value="${quarter.id}" />
                	...
                	<li class="clearfix">
                		...
                		<select class="c_select" id="programId" name="programId" style="width:215px;">
		                     ...
		                     <#list programList as info>
		                     	<#if info.id == (quarter.programId)!0>
               		...
               		<li class="clearfix">
                		...
                		<input class="c_input_text required" type="text" style="width:200px;" name="title" value="${(quarter.title)!''}" id="title" realValue="请输入季名称" maxlength="32" />
               		</li>
               		
               		<li class="clearfix">
                		<label for="sort require digits" class="tit">排序：<span class=" red">*</span></label>
                		<input class="c_input_text required digits" type="text" style="width:200px;" name="sort" id="sort" value="${(quarter.sort)!''}" realValue="请输入节目排序" maxlength="32" />
               		</li>
               		
                	<li class="clearfix">
                		<label for="state" class="tit">状态：<span class=" red">*</span></label>
               			<input type="radio" name="state" value="1" <#if quarter.state ==1 > checked="checked" <#else> </#if> />启用
                		<input type="radio" name="state" value="0" <#if quarter.state ==0 > checked="checked" <#else>  </#if> />停用
                	</li>            
