        ...
        <div class="con_search_top clearfix">
        	<div class="con_search_top_L left">
                <p>
                    ...
                    <span class="group"><label>季名称：</label>
                    	<input name="title" class="c_input_text" type="text" realValue="输入季名称" value="${title!''}"}" />
                    </span>
                    <span class="group"><a id="searchButton" href="javascript:;" class="btn_search">搜索</a></span>
                </p>
            </div>
            <div class="con_search_btn right">
                <a class="btnA" href="javascript:;" onclick="openAddFrame('添加季');">添加季</a>
            </div>
        </div>
