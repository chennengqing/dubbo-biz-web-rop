...
<form id="inputForm" method="post" action="update">
	<input type="hidden" id="infoId" name="id" value="${video.id}" />
            ...
            <ul class="pop_list merchant_type_add">
            		<li class="clearfix">
               		...
               		<li class="clearfix">
                		...
                		<input class="c_input_text required" type="text" style="width:200px;" value="${video.title!''}" name="title" id="title" realValue="请输入期名称" maxlength="32" />
               		</li>
				               		
                	<li class="clearfix">
                		<label for="type" class="tit">类型：<span class=" red">*</span></label>
               			<input type="radio" name="type" <#if 0==(video.type)!0>checked</#if> value="0" />正片
                		<input type="radio" name="type" <#if 1==(video.type)!0>checked</#if> value="1" />花絮
                	</li>
                	...
                	<li class="clearfix">
                        ...
                        <input type="button" value="删除1" id="title_del1" onclick="title_image_del(1)"/>
                       	...
                       	<input class="c_input_text required" type="hidden" value="${video.titleImage!''}" id="titleImage"  name="titleImage"/>
                	...
                	<li class="clearfix">
                    	<label for="introduction" class="tit">简介：</label>
                    	<span class="textarea_show" style="display:inline-block; position:relative;">
	                		<textarea class="c_textarea wordCount" name="introduction" id="introduction" rows="" maxlength="150" showCount="introductionLen">${(video.introduction)!''}</textarea>
                	...
                	<li class="clearfix">
                		<label for="videoUrl" class="tit">视频：<span class=" red">*</span></label>
                       	<input class="c_input_text required" type="text" style="width:400px;" value="${video.videoUrl}" readonly name="videoUrl" id="videoUrl" realValue="请输入链接地址"  />
					...
					<li class="clearfix">
                		<label for="type" class="tit">是否加水印：</label>
               			<span>
               			<input type="checkbox" id="watermark" <#if (1==video.isWatermark!0)>checked</#if> name="watermark" value="1"/>是否水印
               			</span>
                	</li>
            </ul>
